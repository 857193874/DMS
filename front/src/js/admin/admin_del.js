  ...
  function showDeleteConfirm(data) {
    ...
    confirm({
      ...
      onOk() {
        ...
        reqwest({
            url: 'http://[2001:da8:270:2020:f816:3eff:febb:50dd]:8080/dms/api/v1/admin/del/'+data,
            method: 'delete',
            data: {
            },
            type: 'json'
...
class AdminDel extends Component {
    ...
    render() {
      ...
      return (
        ...
        <div style={{display: 'inline-block'}}>
             <Button type="danger" icon="delete" onClick={showDeleteConfirm.bind(this,this.props.adminId)} />
