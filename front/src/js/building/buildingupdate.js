...
class BuildingUpdate extends Component {
  constructor(props) {
    super(props);
  ...
  showModal = () => {
    reqwest({
      url: "http://[2001:da8:270:2020:f816:3eff:febb:50dd]:8080/dms/api/v1/building/query/" + this.props.buildingId,
      method: "get",
      data: {},
      type: "json",
      error: function(err) {},
  ...
  updateBuilding = e => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        reqwest({
          url: "http://[2001:da8:270:2020:f816:3eff:febb:50dd]:8080/dms/api/v1/building/update/"+ this.props.buildingId,
          method: "post",
          data: {
    ...
    return (
      <div style={{ display: "inline-block" }}>
        ...
        <Modal
          ...
          onOk={this.updateBuilding}
          onCancel={this.hideModal}
          okText="确认"
          cancelText="取消"
        >
          <Form horizontal form={this.props.form}>
            <FormItem {...formItemLayout} label=" 宿舍ID">
              {getFieldDecorator("buildingId", {
                initialValue: this.state.data ? this.state.data.buildingId : "",
            ...
            <FormItem {...formItemLayout} label="公寓名">
            ...
            <FormItem {...formItemLayout} label=" 简介">
              {getFieldDecorator("buildingIntroduction", {
                initialValue: this.state.data
                  ? this.state.data.buildingIntroduction
                  : "",
...
BuildingUpdate = createForm()(BuildingUpdate);
