...
/**
 * Servlet implementation class StuGetMaintain
 */
public class StuGetMaintain extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StuGetMaintain() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map m;
		 ...
		 request.getRequestDispatcher("StudentMaintain.jsp").forward(request, response);
	}
