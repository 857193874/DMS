...
/**
 * Servlet implementation class StuAddMaintain
 */
public class StuAddMaintain extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public StuAddMaintain() {
        super();
