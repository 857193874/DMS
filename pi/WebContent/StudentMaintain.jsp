...
<head>
	...
	if(request.getAttribute("MaintainAll")!=null){
		...
		temp=(Maintain)arr.get(0);
		id=temp.getDomitoryId();
	}
	else{
		id="";
	}
...
%>
	...
	function name() {
		 location.href="/DMS/StuAddMaintain?domitoryId=<%=id%>";
		/*  alert("aaa"); */
	}	
...
<div style="width:200px; height:auto; float:left; display:inline">
	<div class="grid__item theme-2" style="background: rgb(0,0,0,0); height: 480px;">
			...
			<button class="particles-button" style="height: 480px; width: 200px; background: rgb(0,0,0,0);" onclick="xxx()">
				<p style="font-size: 38px; font-weight: bold;">提<br/>交<br/>报<br/>修</p>
			</button>
	</div>
</div> 
<div style="width:600px; height:auto; float:left; display:inline">
<div class="btn-toolbar list-toolbar">
  <div style="float: left;"><h4 style="padding-left: 250px; ">往期保修情况</h4></div>     
  ...
  <div class="btn-group"></div>
	...
	<div  class="scroller" style="overflow-y:auto; width:600px; height: 440px;" id="kkk">     
		<table class="table" style=" -webkit-user-select:none;
		    ...
		    -ms-user-select:none;
		    user-select:none;
		    width: 600px; font-size: 20px !important;color: white;"id="table">
		  <thead>
		    <tr>
		      <th>报修id</th>
		      <th>报修时间</th>
		  ...
		  <tbody>
		    ...
		    <tr>
		      ...
		      <td style="width=50px;"><%=temp.getMaintainTime() %></td>
